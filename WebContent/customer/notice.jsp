			...
			<div class="top-wrapper clear">
				<div id="content">
					...
					<p id="cur-page" class="margin-small">
						<span class="strong">${param.pg }</span> /
						10	page
					</p>
					<div id="pager-wrapper" class="margin-small">
						<div class="pager clear">
							...
							<ul>
								<li>
									<a class="strong" href="notice?pg=1&f=${param.f}&q=${param.q}">1</a>
								</li>
								<li>
									<a href="notice?pg=2&f=${param.f}&q=${param.q}">2</a>
								</li>
								<li>
									<a href="notice?pg=3&f=${param.f}&q=${param.q}">3</a>
								</li>
								<li>
									<a href="notice?pg=4&f=${param.f}&q=${param.q}">4</a>
								</li>
								<li>
									<a href="notice?pg=5&f=${param.f}&q=${param.q}">5</a>
								</li>
							</ul>
							<p id="btnNext">
